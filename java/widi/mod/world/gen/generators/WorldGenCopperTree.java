...
public class WorldGenCopperTree extends WorldGenAbstractTree {
	...
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumTypeMaterial.COPPER);

	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumTypeMaterial.COPPER);
