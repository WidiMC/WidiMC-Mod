package widi.mod.world.gen.generators;
...
public class WorldGenAluminiumTree extends WorldGenAbstractTree {
	...
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, EnumHandler.EnumTypeMaterial.ALUMINIUM);

	public static final IBlockState LEAF = BlockInit.LEAVES.getDefaultState().withProperty(BlockLeaf.VARIANT, EnumHandler.EnumTypeMaterial.ALUMINIUM);
